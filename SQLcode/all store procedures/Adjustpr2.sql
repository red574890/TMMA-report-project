USE [TMMA_MAIN]
GO
/****** Object:  StoredProcedure [dbo].[Adjustpr2]    Script Date: 2021/3/5 上午 07:02:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[Adjustpr2]
as
declare 
@TotalNum numeric,
@Num numeric,
...
(select B.eventcode, B.MI003, MB001, MB056 as MainDisrate, B.mdisrate  from INVMB as A 
      ...
      where MI001='123' and MI009 = '2') as B on  A.MB001 = B.itemNum)C
...
where MI001 = @evencode and MI003 = @discountcode and MI009 = '2'
